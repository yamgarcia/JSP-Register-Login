        ...
        <div class="container">
            ...
            <div class="tm-main-content">
                <section class="tm-margin-b-l">
                    <header>
                        <h2 class="tm-main-title">Welcome to Marcos' JSP testing</h2>    
                    </header>
                    
                     <p> 
    					Try registring and loging in.
    					<br>
  					  	MYSQL and Tomcat must be open.
  					  	<br>
    					cmd: 
    					<br>
    					c:\mysql>cd bin
						...
						~Good as gold~
						<br>
						access: http://localhost:8081/JEETut1/index.jsp				
  					</p>  
