        ...
        <div class="container">
            ...
            <div class="tm-main-content">
                <section class="row tm-margin-b-l">
                    <div class="col-12">
                        <h2 class="tm-blue-text tm-margin-b-p">Insert your login info below</h2>
                    </div>
                    <div class="col-md-6 col-sm-12 mb-md-0 mb-5 tm-overflow-auto">         
                        <div class="mr-lg-5">
                            ...
                            <form action="ProcessInfo" method="post" class="tm-contact-form">
                                ...
                                <div class="form-group">                                                        
                                    <input type="text" id="contact_email" name="pass" class="form-control" placeholder="Password"  required/>
                                </div>
                                    <!--
                                    	<textarea id="contact_message" name="contact_message" class="form-control" rows="8" placeholder="Message" required></textarea>
                                    -->
                                </div>
                                <button type="submit" value="Submit" class="tm-btn tm-btn-blue float-right">Submit</button>
                            </form>
